    ...
    echo '</pre>';
                ...
                <div class="col-lg-12">
                  ...
                  <div class="card-header py-2">
                    <h4 class="m-1 text-lg text-primary">Medical Products category</h4>
                  </div>
                        <!-- /.panel-heading -->
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs">
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#devices" data-toggle="tab">Devices</a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link" href="#" data-target="#drugs" data-toggle="tab">Pharmaceutical Drugs</a>
                              </li>
...
<!-- END TAB PANE AREA - ANG UNOD KA TABS ARA SA TABPANE.PHP -->
        ...
        <div class="card-header py-3 bg-white">
          <h4 class="m-2 font-weight-bold text-primary">Your Invoice</h4>
        </div>
