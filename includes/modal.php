...
<!-- end of Employee select and script -->
  ...
  <div class="modal fade" id="poscustomerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add Cfffustomer</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="emp_transac.php?action=add">
              <div class="form-group">
                <input class="form-control" placeholder="Staff Number" name="staffno" value="<?php $rn = rand(1000000, 9999999); echo $rn;?>" readonly required>
              </div>          
              <div class="form-group">
...
<div class="modal fade" id="appointmentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Submit Your Appointment</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
          <form role="form" method="post" action="apoint_transac.php?action=add">
              <div class="form-group">
                <input class="form-control" placeholder="code" name="apointcode" value="<?php $rn = rand(1000000, 9999999); echo $rn;?>" readonly required>
              </div>          
              <div class="form-group">
                <input class="form-control" placeholder="Name" name="clname" readonly value="<?php echo  $_SESSION['FIRST_NAME'];?>"required>
              </div>
              ...
              <div class="form-group">
                <input class="form-control"  placeholder="Date" name="appdate" required type="date">
              </div>
              <div class="form-group">
                <input class="form-control"  placeholder="Time" name="apptime" required type="time">
              </div>
			   <div class="form-group">
